...
import {AppBar, Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Menu, MenuItem, Toolbar, Typography, useTheme,} from '@mui/material';
...
function Navbar() {
    ...
    const menuItems = [
        ...
        {text: 'Driver Log Sheet', icon: <DocumentScannerSharpIcon/>, path: Constants.ROUTES.LOG_SHEET}
    ]
    return (
        <>
            {/* Sidebar for Desktop */}
