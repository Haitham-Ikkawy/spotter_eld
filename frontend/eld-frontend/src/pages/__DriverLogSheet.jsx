        ...
        <Container>
            ...
            <Box sx={{ textAlign: "center", mt: 4 }}>
                ...
                <Box sx={{ textAlign: "left", mb: 4 }}>
                    <Typography variant="h6">US. DEPARTMENT OF TRANSPORTATION</Typography>
                    <Typography variant="subtitle1">04 09 2021</Typography>
                    <Typography variant="subtitle1">(MONTH) (DAY) (YEAR)</Typography>
                    <Typography variant="subtitle1">(TOTAL MILES DRIVING TODAY)</Typography>
                </Box>

                {/* Driver Information */}
                <Box sx={{ textAlign: "left", mb: 4 }}>
                    <Typography variant="h6">John Doe’s Transportation</Typography>
                    <Typography variant="subtitle1">(NAME OF CARRIER OR CARRIERS)</Typography>
                    <Typography variant="subtitle1">Washington, D.C.</Typography>
                    <Typography variant="subtitle1">(NAME OF P.E. & ADDRESS)</Typography>
                </Box>

                {/* Original and Duplicate Notes */}
                <Box sx={{ textAlign: "left", mb: 4 }}>
                    <Typography variant="body2">ORIGINAL – Submit to carrier within 13 days</Typography>
                    <Typography variant="body2">DUPLICATE – Driver retains possession for eight days</Typography>
                </Box>

                {/* Vehicle Numbers and Signature */}
                <Box sx={{ textAlign: "left", mb: 4 }}>
                    <Typography variant="body2">123, 20544</Typography>
                    <Typography variant="body2">VEHICLE NUMBERS – (SHOW EACH UNIT)</Typography>
                    <Typography variant="body2">John E. Doe</Typography>
                    <Typography variant="body2">(DRIVER’S SIGNATURE IN FULL)</Typography>
                </Box>
                ...
                <TableContainer component={Paper} sx={{ mb: 4 }}>
                    <Table>
                        ...
                        <TableBody>
                            {Object.entries(logData.total_hours).map(([status, hours]) => (
                                <TableRow key={status}>
                                    <TableCell>{status}</TableCell>
                ...
                <Box sx={{ textAlign: "left", mb: 4 }}>
                    ...
                    {logData.remarks.map((remark, index) => (
                        <Typography key={index} variant="body2">{remark}</Typography>
                    ))}
